...
gStyle->SetPalette(1,0);
 ...
 TPaveLabel *title = new TPaveLabel(.15,.90,0.95,.99,htitle,"ndc");
   TString inputroot;
   inputroot="/group/c-polhe3/Users/murchhana/mc-single-arm/worksim/"+basename+".root";
   TString outputhist;
   outputhist="/group/c-polhe3/Users/murchhana/mc-single-arm/worksim/"+basename+"_hist.root";
   // TObjArray HList(0);
     TString outputpdf;
    outputpdf="/group/c-polhe3/Users/murchhana/mc-single-arm/outfiles/"+basename+".pdf";
